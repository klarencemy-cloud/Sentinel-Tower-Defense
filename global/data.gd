...
enum Enemy {DEFAULT, VIRUS, ADWARE, WORM, SPYWARE, TROJAN, BOTNET, CREDS, INSIDERTHREAT, ROOTKIT, SQL, DDOS, RANSOMWARE, ZERO, BOSS1, BOSS2, BOSS3, BOSS4}
...
var ENEMY_DATA = {
	...
	Enemy.BOSS3: {'health': 50000, 'texture': "res://graphics/Ships/ship_0015.png", 'speed': 100, 'name': "boss3", 'damage': 330, "exp": 5},
	Enemy.BOSS4: {'health': 90000, 'texture': "res://graphics/Ships/ship_0015.png", 'speed': 100, 'name': "boss4", 'damage': 300, "exp": 5}
}
